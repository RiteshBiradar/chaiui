export const TestimonialCard = `import React, { ReactNode } from "react";
...
function TestimonialCard({
  ...
  return (
    <div
      className={\`rounded-2xl p-6 w-full max-w-84 h-110 flex flex-col justify-between shadow-md transition-all duration-300 hover:shadow-lg hover:scale-[1.01] \${ChaiTheme
    ...
    >
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="w-14 h-14 rounded-full overflow-hidden border dark:border-gray-700">
          {personImage ? (
            ...
            <div
              className={\`w-full h-full flex items-center justify-center \${ChaiTheme
        ...
        <div
          className={\`px-4 py-2 rounded-xl border text-sm font-medium \${ChaiTheme
      ...
      {/* Quotation mark */}
      <div
        className={\`text-5xl font-serif mb-1.5 \${ChaiTheme
      ...
      <div className="flex-grow mb-6">
        <div
          className={\`text-base leading-relaxed line-clamp-4 \${ChaiTheme
      ...
      {/* Footer */}
      <div
        className={\`border-l-2 pl-4 py-1 \${ChaiTheme
            ? "border-amber-300 dark:border-amber-700"
            : "border-gray-300 dark:border-gray-700"
        }\`}
      >
        <div
          className={\`font-semibold \${ChaiTheme
