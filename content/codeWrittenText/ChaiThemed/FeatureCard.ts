export const FeatureCardCode = `import React from "react";
...
function FeatureCard({
  ...
  return (
    ...
    >
      ...
      {/* Title */}
      <h3
        className={\`text-xl font-bold mb-2 \${ChaiTheme ? "text-amber-900 dark:text-amber-100" : ""}\`}
      >
        {title}
      </h3>
      ...
      {/* Description */}
      <p
        className={\`text-sm flex-grow \${ChaiTheme
